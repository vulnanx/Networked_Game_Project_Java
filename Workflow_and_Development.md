...
## **2.1 Member Assignments**

| Member | Role | Primary Responsibility | Key Deliverables |
| ----- | ----- | ----- | ----- |
| Member A (Christel) | Engine Lead | Game loop, rendering, input, HUD | GameLoop, Renderer, InputHandler, HUD, GameState |
| Member B (Sophia) | Entity Lead | Player, enemies, bullets, collision | Player, Enemy subtypes, Bullet, CollisionDetector |
| Member C (Geastin) | Systems Lead | Rounds, spawning, power-ups | RoundManager, EnemySpawner, EntityManager, PowerUp |
